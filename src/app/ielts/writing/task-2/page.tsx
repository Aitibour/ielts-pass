    ...
    <main className="relative flex-1">
      ...
      <section className="border-b border-gray-200 bg-white/80 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
          <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500">
            ...
            <span>/</span>
            <span className="font-medium text-navy">Writing Task 2</span>
          </div>

          <div className="mt-6 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-ielts-green">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-gray-500">
                Essay prompts from the IELTS Fever archive. Open the source article
                for the full wording and write your answer here.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <div className="rounded-2xl border border-gray-200 bg-white px-4 py-4 shadow-card">
                ...
                <div className="mt-1 text-2xl font-extrabold text-gray-900">250</div>
              </div>
              <div className="rounded-2xl border border-gray-200 bg-white px-4 py-4 shadow-card">
                <div className="text-[10px] font-semibold uppercase tracking-[0.2em] text-gray-400">
                  Prompts
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-4 py-8 lg:grid-cols-[360px_minmax(0,1fr)] lg:px-8">
        ...
        <aside className="rounded-3xl border border-gray-200 bg-white p-5 shadow-card">
          <div className="text-base font-bold text-gray-900">Task 2 Library</div>
          <p className="mt-2 text-sm leading-6 text-gray-400">
            Titles from the IELTS Fever archive.
          </p>
              ...
              <button
                ...
                className={`w-full rounded-2xl border p-4 text-left transition ${
                  selectedTask.id === task.id
                    ? "border-ielts-green/30 bg-emerald-50 shadow-md"
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="max-w-3xl">
                ...
                <p className="mt-2 text-sm leading-6 text-gray-500">
                  Open the source for the exact question and sample material.
                </p>
              </div>
              <a
          ...
          <section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-card">
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                ...
                {isRunning ? "Pause" : "Start 40-Min Timer"}
              </button>
              <button
                type="button"
                onClick={resetTask}
            ...
            <textarea
              ...
              className="mt-5 min-h-[460px] w-full resize-y rounded-2xl border border-gray-200 bg-gray-50 px-5 py-4 text-base leading-7 text-gray-900 outline-none transition placeholder:text-gray-300 focus:border-primary focus:bg-white focus:ring-1 focus:ring-primary"
            />

            <div className="mt-4 flex flex-wrap gap-3 text-sm">
              <div className="rounded-full bg-emerald-50 px-4 py-2 font-medium text-ielts-green">
                Words: {wordCount}
              </div>
              <div
              ...
              >
                {wordCount >= 250 ? "Minimum reached" : "Target: 250+ words"}
              </div>
            </div>

            {/* Save band */}
            <div className="mt-5 rounded-2xl bg-gray-50 p-4">
              <div className="text-sm font-bold text-gray-900">Save Task 2 Band</div>
                ...
                <button
                  ...
                  onClick={() =>
                    saveGeneralIeltsScores({
                      writingTask2Band: Math.max(0, Math.min(9, Number(bandInput) || 0)),
                    })
                  }
                  className="inline-flex items-center gap-2 rounded-xl bg-accent px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-accent-dark"
                >
